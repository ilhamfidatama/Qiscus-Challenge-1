...
class Member{
    // PLACE YOUR CODE HERE
    String name;
    private final java.util.List<Book> borrowList = new ArrayList<>();
    private final FictionBookLibrary bookLibrary;

    Member(String name, FictionBookLibrary bookLibrary){
        this.name = name;
        this.bookLibrary = bookLibrary;
    }

    public void borrow(Book book){
        Book availableBook = bookLibrary.borrow(book);
        if (availableBook != null){
            borrowList.add(availableBook);
        }
    }
